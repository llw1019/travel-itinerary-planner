...
| `references/output-checklist.md` | 硬擋 15 項 + 完整驗收清單(214 項,交付詳細版實跑 164 項) | Step 6,交付前 |
...
- 加規則之前先想清楚它會不會讓問卷輪次或驗收清單膨脹到被跳著看。題庫已 ~80 項、清單已 214 項,**再加東西要同時說明怎麼維持可用**
- 檔案一律 UTF-8 無 BOM
