...
| `references/output-checklist.md` | 硬擋 17 項 + 完整驗收清單(250 項,交付詳細版實跑 185 項) | Step 7,交付前 |
...
4. **在 reference 改了規則之後,回頭改 SKILL.md 裡重述它的那段摘要。** 這是**發生頻率最高的一種** —— 一次 review 抓到的 13 個問題裡有 7 個是它。SKILL.md 永遠載入而 reference 未必當下會讀,所以摘要過時的殺傷力比 reference 本身有錯還大:它會讓人照著一份看起來完整、其實少了一條的清單做事。
   ...
   - Step 9 的**加圖八步**與深度介紹六點 ← `html-output-spec.md`
...
- 加規則之前先想清楚它會不會讓問卷輪次或驗收清單膨脹到被跳著看。題庫已 ~80 項、清單已 250 項,**再加東西要同時說明怎麼維持可用**
- 檔案一律 UTF-8 無 BOM
