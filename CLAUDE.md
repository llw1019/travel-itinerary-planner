...
| 檔案 | 職責 | skill 執行時何時讀 |
|---|---|---|
| `SKILL.md` | 環境對應表、三種入口(A／B1／B2)、流程 Step 0–9 | 永遠載入 |
...
| `references/html-output-spec.md` | 14 個必含區塊的欄位規格、兩環境交付流程、階段一 + 兩種衍生版(B5 列印手冊／A4 精簡版) | Step 5、Step 8、Step 9 |
| `references/editorial-standards.md` | 編輯判斷、推薦理由寫法、用字與專有名詞 | Step 5,寫內容時 |
| `references/output-checklist.md` | 硬擋 15 項 + 完整驗收清單(205 項,交付詳細版實跑 159 項) | Step 6,交付前 |
...
- 加規則之前先想清楚它會不會讓問卷輪次或驗收清單膨脹到被跳著看。題庫已 ~80 項、清單已 205 項,**再加東西要同時說明怎麼維持可用**
- 檔案一律 UTF-8 無 BOM
