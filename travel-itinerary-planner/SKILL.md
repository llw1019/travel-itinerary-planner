...
- 城市間/景點間的實際交通時間,不要讓行程時間對不上——前一項結束時間 + 交通時間 ≤ 下一項開始時間,自己重算一遍,不要目測。
...
視覺質感不能取代內容密度,而**欄位填滿也不等於有編輯判斷**。完整標準在 `references/output-checklist.md` 第三、四節,寫法見 `references/editorial-standards.md`,排完後逐項對照。最核心的六條:
