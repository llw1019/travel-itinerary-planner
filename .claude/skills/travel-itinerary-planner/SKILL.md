...
9. **交付時主動問四件事**:要不要加使用者自己的圖片、要不要發布成 artifact、要不要做 B5 列印手冊、要不要做 A4 精簡版。使用者不會知道有這些選項,除非你講。
...
8. **加圖也是改版**:已做過的衍生版要重生成,已發布過的 artifact 要問一句要不要同步更新網址(同 Step 8 的第 9、10 點)
